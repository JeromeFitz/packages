          ...
          >
            <NextLink href="/" legacyBehavior passHref>
              ...
              >
                ...
                {focused === calloutId ? <Focused layoutId="highlight" type="callout" /> : null}
        ...
        {menu.map((menuItem) => {
          ...
          return hasChildren ? (
            <NavigationMenuItem key={`kmi-${id}`}>
              <NavigationMenuTriggerWithCaret>{title}</NavigationMenuTriggerWithCaret>
              <NavigationMenuContent>
                <NavigationMenuContentContainer id={id} items={items} layout={layout} />
              </NavigationMenuContent>
            </NavigationMenuItem>
          ) : (
            <NavigationMenuItem key={`kmi-${id}`}>
