...
type Endpoint = "ARTISTS" | "NOW_PLAYING" | "RECENTLY_PLAYED" | "TOP_ARTISTS" | "TOP_TRACKS";
...
export { API_VERSION, ENDPOINTS, LIMIT, OFFSET, OMIT_FIELDS, PACKAGE_NAME, PACKAGE_VERSION, URL };
