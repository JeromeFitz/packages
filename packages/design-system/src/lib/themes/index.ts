...
const themes: Themes = {
  light: {
    colors: {
      ...
      errorEmpahsis: '$colors$red9',
      errorEmphasisHover: '$colors$red8',
      errorText: '$colors$red3',
      errorTextHover: '$colors$red2',
      // info
      info: '$colors$blue11',
      infoHover: '$colors$blue10',
      infoEmpahsis: '$colors$blue9',
      infoEmphasisHover: '$colors$blue8',
      infoText: '$colors$blue3',
      infoTextHover: '$colors$blue2',
      // success
      success: '$colors$green11',
      successHover: '$colors$green10',
      successEmpahsis: '$colors$green9',
      successEmphasisHover: '$colors$green8',
      successText: '$colors$green3',
      successTextHover: '$colors$green2',
      // warning
      warning: '$colors$orange11',
      warningHover: '$colors$orange10',
      warningEmpahsis: '$colors$orange9',
      warningEmphasisHover: '$colors$orange8',
      warningText: '$colors$orange3',
      warningTextHover: '$colors$orange2',
